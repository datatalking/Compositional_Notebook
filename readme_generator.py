...
class GitRepoReadMe:
    ...
    # TODO update so user is prompted for github_user_name
    ...
    _purpose = (
        """# Purpose ###  PurposeTo automatically create README.md files for project"""
    )
    _cloning = """
    ### Setup and Usage
    ...
    def add_contribs(self):
        ...
        :return:
        """
        contribs = ["datatalking", "{1}", "Tralehtek"]
        h = "\n\n# Contributors. \n\n"
        return h + "\n".join(
            ["* [%s](%s)" % (r, "https://github.com/" + r) for r in contribs]
        )
...
# TODO prompt user to enter repository_name
if __name__ == "__main__":
    github_user_name = "datatalking"
    repository_name = "Compositional_Notebook"
    ps = ArgumentParser(
        description="Generate a README.md file in markdown for any github repository."
    )
    ps.add_argument(
        "-n",
        "--name",
